...
//******************************************************************************* */
    ...
    setProducto({
      ...producto,
      [name]: value ? Number(value) : 0  // Convierte el valor a número, o asigna 0 si está vacío
    });
  }
  //****************************************************************************** */
  ...
  return (
    <form onSubmit={manejarEnvio} style={{ maxWidth: '600px', margin: '0 auto', padding: '20px' }}>
      ...
      {modo === "editar" && productoRecibido && (
        <p style={{color: '#666', fontStyle: 'italic'}}>Editando: {productoRecibido.nombre} (ID: {productoRecibido.id}) </p>
      )}
